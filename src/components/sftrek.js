...
const SftrekData = (props) => {
  ...
  return (
    <div>
      ...
      >
        <FlexTagBox>
          <TrekTag style={{ backgroundColor: `${colors.mountain1}` }}>
            {' '}
            Maximum Altitude {altitude} meters{' '}
          </TrekTag>
          {months.map((item) => (
            <TrekTag
              style={{ backgroundColor: `${colors.mountain2}` }}
              key={item}
            >
              {' '}
              {item}{' '}
          ...
          {season.map((item) => (
            <TrekTag
              style={{ backgroundColor: `${colors.mountain3}` }}
              key={item}
            >
              {' '}
              {item}{' '}
          ...
          {region.map((item) => (
            <TrekTag
              style={{ backgroundColor: `${colors.mountain4}` }}
              key={item}
            >
              {' '}
              {item}{' '}
          ...
          {noofdays.map((item) => (
            <TrekTag
              style={{ backgroundColor: `${colors.mountain5}` }}
              key={item}
            >
              {' '}
              {item} days{' '}
          ...
          <TrekTag style={{ backgroundColor: `${colors.mountain6}` }}>
            {' '}
            Minimum Age {minage} yrs{' '}
          </TrekTag>
        </FlexTagBox>
