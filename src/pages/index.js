...
export default function Index(props) {
  ...
  const description =
    'Join us for the treks and tours in the Garhwal Indian Himalayas. Dayara Bugayal, Dodital, Audens Col, Kedartal are some of our famous treks.';
  ...
  return (
    <Photon>
      <Helmet>
        ...
        <meta
          name="Keywords"
          content={'Dayara Bugyal trek, Dodital trek, Kedartal trek'}
        />
        <meta property="og:title" content={title} />
        <meta property="og:url" content={`https://mountainadvice.com`} />
        <meta property="og:description" content={description} />
        <meta name="twitter:description" content={description} />
        {data && data.bgImage.resize.src && (
          <meta
            property="og:image"
